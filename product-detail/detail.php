                        ...
                        <div class="size my-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="font-rubik border p-2">
                                    <button class="btn p-0 font-size-14"><?php echo ''.$row['config1'].'' ?></button>
                                </div>
                                <div class="font-rubik border p-2">
                                    <button class="btn p-0 font-size-14"><?php echo ''.$row['config2'].'' ?></button>
                                </div>
                                <div class="font-rubik border p-2">
                                    <button class="btn p-0 font-size-14"><?php echo ''.$row['config3'].'' ?></button>
                                </div>
                            </div>
                        </div>
                        <!-- !size -->
