                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <div id="order-details" class="font-rale d-flex flex-column text-dark">
                            ...
                            <small>Nhà sản xuất <a href="#"><?php echo ''.$row['brand'].'' ?> </a></small>
                        ...
                        <div class="tab-content">
                            <div id="info-product" class="tab-pane fade show active pt-3">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <th>RAM</th>
                                        <th>4GB DDR4 2400MHz Onboard ( 1x onboard 4GB + 1x SO-DIMM socket, up to 12GB
                                            SDRAM)
                                        </th>
                                    </tr>
                                    <tr>
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item py-2">
                        <div class="product font-rale">
                            <a href="#"><img src="./1.png" alt="product1" class="img-fluid"></a>
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-warning font-size-12">Chi tiết</button>
                            </div>
                        </div>
                    </div>
                    <div class="item py-2">
                    ...
                    <div class="item py-2">
                        <div class="product font-rale">
                            <div class="d-flex flex-column">
                                <a href="#"><img src="./1.png" class="img-fluid" alt="pro1"></a>
                                <div class="text-center">
                                    <h6>Readme Note 7</h6>
                                    <div class="rating text-warning font-size-12">
                                        <span><i class="fas fa-star"></i></span>
